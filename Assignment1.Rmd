...
dat.sf <- st_read("regression data shapefile/RegressionData.shp", quiet = TRUE)
```
...
```{r k-folds cv, echo=TRUE, message=FALSE, warning=FALSE, cache=TRUE, results='hide'}
