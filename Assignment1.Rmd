...
** think we need to be careful with interpretation here because MEDHVAL is log transformed
...
Given the earlier variable distributions
...
As part of our exploratory data analysis process, we examine the summary statistics and distributions of variables. We will also examine the correlations between predictors. Correlation describes the statistical relationship or dependence between two variables. It is quantified using the sample correlation coefficient $r$. $r$ is calculated using the following formula: 
$$r = \frac{n(\Sigma xy)-(\Sigma x)(\Sigma y)}{\sqrt{[n\Sigma x^{2}-(\Sigma x)^{2}][n\Sigma y^{2}-(\Sigma y)^{2}]}}$$
...
>>>>>>> 0b4b12ce5c1a2734752067a59ec0b9723607f532
